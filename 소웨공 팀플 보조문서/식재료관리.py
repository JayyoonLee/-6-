...
add_button = tk.Button(root, text="식재료  추가", command=add_ingredient)
add_button.pack()
show_button = tk.Button(root, text="식재료  목록", command=show_ingredients)
show_button.pack()
delete_button = tk.Button(root, text="식재료  삭제", command=delete_ingredient)
delete_button.pack()
check_button = tk.Button(root, text="유통기한 확인", command=check_expiration)
check_button.pack()
